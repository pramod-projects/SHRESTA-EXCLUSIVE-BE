...
public final class CategoryProductTypeConfigMigration {

    private CategoryProductTypeConfigMigration() {}

    public static TransitionPlan transitionPlan() {
        return TransitionPlan.forTable("category_product_type_config")
