...
class StorefrontAdminExceptionHandler {
    ...
    @ExceptionHandler({StorefrontHomeItemNotFoundException.class, StorefrontHomeSectionNotFoundException.class})
    @ResponseStatus(HttpStatus.NOT_FOUND)
    ApiResponse<Void> notFound(RuntimeException exception) {
        return ApiResponse.failed("STOREFRONT_DATASET_NOT_FOUND", exception.getMessage(), traceId());
    }
