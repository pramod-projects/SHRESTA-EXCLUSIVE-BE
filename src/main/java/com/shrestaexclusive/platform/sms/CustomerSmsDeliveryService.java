...
public class CustomerSmsDeliveryService {
    ...
    public void sendRegistrationOtp(UUID customerId, String mobile, String otp) {
        sendOtp(customerId, mobile, otp, "REGISTRATION_OTP");
    }

    public void sendLoginOtp(UUID customerId, String mobile, String otp) {
        sendOtp(customerId, mobile, otp, "LOGIN_OTP");
    }

    private void sendOtp(UUID customerId, String mobile, String otp, String purpose) {
        ...
        sendCustomerSms(customerId, normalizedMobile, purpose, messageBody);
    }
